<template>
    <div id="scroll-progress-bar" :class="[
            'fixed left-1/2 bottom-2 -translate-x-1/2 w-[90vw] max-w-[900px] h-6 pointer-events-none opacity-0 transition-opacity duration-400 ease-[cubic-bezier(.4,0,.2,1)] z-[1000] flex items-center justify-center',
            isVisible ? 'opacity-100' : '',
        ]">
        <div
            class="bar absolute left-0 right-0 top-1/2 h-0.5 bg-white rounded w-full -translate-y-1/2 shadow-[0_0_8px_0_rgba(255,255,255,0.08)]">
        </div>
